...
/**
 * Manages the user interface interactions for Student Enquiries.
 */
public class StudentEnquiryUI implements UI {
    ...
    /**
     * View Remaining Camps
     * @return A map representing the camp names and their remaining slots.
     */
    ...
    void editEnquiries(){
        ...
        int index = -2;
        Scanner scanner = new Scanner(System.in);
        while (index < -1 || index >= enquiries.size()) {
            System.out.println("Please enter the number you want to edit. Put -1 to leave without editing");
    ...
    void deleteEnquiry(){
        ...
        Scanner scanner = new Scanner(System.in);
        while (index < -1 || index >= enquiries.size()) {
            System.out.println("Please enter the number you want to delete the enquiry from. Put -1 to leave without deleting");
            index = scanner.nextInt();
        }
        if(index == -1){
            System.out.println("returning...");
