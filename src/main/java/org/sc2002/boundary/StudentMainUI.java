...
/**
 * Manages the user interface interactions for Student.
 */
public class StudentMainUI implements UI{
    ...
    void printCampsWithSlots(Filter filter){
        ...
        System.out.printf("%-20s %-15s %-20s %-15s %-15s %-20s%n", "CAMP NAME", "REMAINING SLOTS", "LOCATION", "START DATE", "END DATE", "REGISTRATION END DATE");
        for(Camp camp : filteredCamps){
            ...
            System.out.printf("%-20s %-15d %-20s %-15s %-15s %-20s%n", camp.getCampName(), remainSlots, camp.getLocation(), camp.getCampStartDate(), camp.getCampEndDate(), camp.getCampRegistrationEndDate());
        }
    }
