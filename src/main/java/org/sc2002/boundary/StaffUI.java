...
/**
 * Manages the user interface interactions for Staff.
 */
public class StaffUI implements UI{
     ...
     * @param enquiryController
     * @param suggestionController
     */
    ...
    void replyEnquiryAsStaff(){
        ...
        if(!enquiry.getAnswer().equals("NOT BEEN ANSWERED")){
            ...
            Enquiry updatedEnquiry = new Enquiry(enquiry.getID(), enquiry.getStaffID(), enquiry.getStudent(), enquiry.getCamp(), enquiry.getQuery(), reply);
            enquiryController.editEnquiry(updatedEnquiry);
    ...
    void approveSuggestion(){
        ...
        Suggestion approvedSuggestion = new Suggestion(suggestionToApprove.getSuggestionID(), suggestionToApprove.getStaffID(), suggestionToApprove.getStudent(), suggestionToApprove.getCamp(), suggestionToApprove.getSuggestion(), true);
        suggestionController.editSuggestion(approvedSuggestion);
